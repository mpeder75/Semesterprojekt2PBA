# Semesterprojekt2PBA
> Konvertering af Monolit til Microservices

## 🔗 Links
| Ressource | Link |
|---|---|
| eShopOnWeb (monolit) | [dotnet-architecture/eShopOnWeb](https://github.com/dotnet-architecture/eShopOnWeb) |
| Dokumentation | *(indsæt link til Googledrev etc )* |
...
*(Tilføj arkitekturdiagram/Er diagram her når det er færdigt)*

---

##  Opsætning -> Opdateres løbendne mens projekt udvikler sig
